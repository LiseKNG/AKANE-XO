...
export async function tagall(client, message) {
    ...
    try {
        ...
        await client.sendMessage(remoteJid, {
            text: `╭━━━〔 🌸 AKANE-XO BROADCAST 〕━━━⬣
┃
${text}
┃
╰━━━〔 ⚡ Powered by AKANE WINTER 〕━━━⬣`,
...
export async function tag(client, message) {
    ...
    try {
        ...
        const text = global.AKANE_UPDATE_MESSAGE || parts.slice(1).join(' ') || '⚡ AKANE-XO SIGNAL'
